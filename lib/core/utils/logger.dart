...
/// logInfo('FCM token registered');
/// logWarning('Compression failed, using original: $e');
/// logError('upload failed', e, stack);
/// ```
///
/// The root logger is configured once at app startup (see [setupLogging]).
/// In debug builds it prints to the console; in release builds you can swap
/// the [LogPrinter] for a remote/crash reporter without touching call sites.
